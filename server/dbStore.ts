...
const buildInitialState = (): DbState => {
  return {
    users: [
      { id: 1, username: 'admin', email: 'admin@university.com', role: 'ADMIN', isActive: true, createdAt: '2026-01-01T00:00:00.000Z', password: 'admin' },
    ...
    staffSubjects: [
      { id: 1, staffId: 1, subjectId: 1, academicYear: '2026' },
      { id: 2, staffId: 1, subjectId: 2, academicYear: '2026' },
      { id: 3, staffId: 1, subjectId: 4, academicYear: '2026' }, // Thermodynamics to John Doe
      { id: 4, staffId: 2, subjectId: 5, academicYear: '2026' }, // Fluid Mechanics to Robert Boyle
      { id: 5, staffId: 3, subjectId: 6, academicYear: '2026' }, // Theory of Machines to Isaac Newton
      { id: 6, staffId: 4, subjectId: 7, academicYear: '2026' }, // Strength of Materials to Richard Feynman
    ],
    studentEnrollments: [
